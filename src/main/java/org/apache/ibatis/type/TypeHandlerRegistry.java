...
public final class TypeHandlerRegistry {
    ...
    /**
     * {@link JdbcType} 类型与{@link TypeHandler} 类型的映射关系
     */
    ...
    /**
     * 注册类型处理器:
     * 类型处理器会根据{@link MappedTypes} 注解来获取应该注册的类型名称，如果没有使用{@link MappedTypes}注解实现，
     * 则判断是否为{@link TypeReference}类型的实现类，如果是，则通过{@link TypeReference#rawType} 来进行推算需要映射的类名称。
     * 在以上两种情况都不满足时，则注册为null。
     ...
     * @param typeHandlerClass 类型处理对象实例
     * @param <T>
     * @return
     */
    @SuppressWarnings("unchecked")
